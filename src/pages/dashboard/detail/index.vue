    ...
    <t-card class="box-card">
      ...
      <div class="form-container">
        ...
        <div class="form-footer">
          <t-button v-if="active > 0" theme="default" @click="prev">上一步</t-button>
          <t-button v-if="active < 2" theme="primary" @click="next">下一步</t-button>
          <t-button v-if="active === 2" theme="success" @click="submitForm">提交</t-button>
        </div>
      </div>
    </t-card>
  </div>
...
const ConfirmInfo = defineAsyncComponent(() => import("./components/ConfirmInfo.vue"));
...
const { form: detailForm } = useDetailForm(
  {
